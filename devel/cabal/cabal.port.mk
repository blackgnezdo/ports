...
#   is used to generate the build plan where it will be available without parsing.
...
.for _data in ${MODCABAL_DATA_DIRS}
_MODCABAL_INSTALL_TARGET +=  \
	&& ${INSTALL_DATA_DIR} ${WRKSRC}/${_data} ${PREFIX}/share/${DISTNAME} \
	&& cd ${WRKSRC}/${_data} && umask 022 && pax -rw . ${PREFIX}/share/${DISTNAME}
.endfor
.endif
